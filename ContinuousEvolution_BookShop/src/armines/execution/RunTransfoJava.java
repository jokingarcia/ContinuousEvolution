...
public class RunTransfoJava {
	/*
	 *BookShop2HTMLModel.atl
	 *metamodels: UML.ecore, SWML.ecore
	 *input: BookShop.uml
	 *output: sWML_Model.xmi
	 */
	...
	public void runTransformation(String pMetamodel, String pMetamodel2, String pTransformation, String pInputModel, String pOutputModel){
		try {
			...
			transformationLauncher.addInModel(inputModel, "IN", "UML");
			transformationLauncher.addOutModel(outputModel, "OUT", "SWML");
	...
	public static void main(String[] args) {
		...
		rtj.runTransformation("metamodels/UML.ecore", "metamodels/SWML.ecore", "transformations/BookShop2sWML.asm",
				"models/BookShop.uml","models/sWML_Model.xmi");
