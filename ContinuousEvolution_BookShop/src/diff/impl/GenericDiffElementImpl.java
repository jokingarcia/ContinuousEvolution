 ...
 * <ul>
 *   <li>{@link diff.impl.GenericDiffElementImpl#getLeftElement <em>Left Element</em>}</li>
 *   <li>{@link diff.impl.GenericDiffElementImpl#getRightElement <em>Right Element</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class GenericDiffElementImpl extends DiffElementImpl implements GenericDiffElement {
		...
		if (leftElement != null && leftElement.eIsProxy()) {
			...
			if (leftElement != oldLeftElement) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DiffPackage.GENERIC_DIFF_ELEMENT__LEFT_ELEMENT, oldLeftElement, leftElement));
			}
		}
		return leftElement;
	}
	...
	public void setLeftElement(EObject newLeftElement) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DiffPackage.GENERIC_DIFF_ELEMENT__LEFT_ELEMENT, oldLeftElement, leftElement));
	}
	...
	public EObject getRightElement() {
		if (rightElement != null && rightElement.eIsProxy()) {
			...
			if (rightElement != oldRightElement) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DiffPackage.GENERIC_DIFF_ELEMENT__RIGHT_ELEMENT, oldRightElement, rightElement));
			}
		}
		return rightElement;
	}
	...
	public void setRightElement(EObject newRightElement) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DiffPackage.GENERIC_DIFF_ELEMENT__RIGHT_ELEMENT, oldRightElement, rightElement));
	}
